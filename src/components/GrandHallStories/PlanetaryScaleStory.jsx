...
export default function PlanetaryScaleStory({ hall, nodes, missions, onOpenMission }) {
  ...
  return (
    <div className="story-page story-page--planetary">
      ...
      <StoryTour items={[{ id: 'story-why', label: '为什么重要' }, { id: 'planetary-core', label: '行星际尺度' }, { id: 'deep-dive', label: '绕 · 落 · 巡' }, { id: 'story-next', label: '下一步' }]} />
